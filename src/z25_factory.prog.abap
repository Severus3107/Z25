...
TRY.
    go_airplane = lcl_airplane=>get_plane( iv_name = 'Lorch' iv_planetype = '727-200' ).
    gt_airplanes = value #( base gt_airplanes ( go_airplane ) ).
   " = value #( base ( gt_airplanes ) go_airplane ).
CATCH cx_s4d400_wrong_plane.
    MESSAGE  'planetype does not exist' TYPE 'I'.
ENDTRY.

TRY.
    go_airplane = lcl_airplane=>get_plane( iv_name = 'plant' iv_planetype = '767-200' ).
    gt_airplanes = value #( base gt_airplanes ( go_airplane ) ).
   " = value #( base ( gt_airplanes ) go_airplane ).
CATCH cx_s4d400_wrong_plane.
    MESSAGE  'planetype does not exist' TYPE 'I'.
...
TRY.
    go_airplane = lcl_airplane=>get_plane( iv_name = 'HarrHarry' iv_planetype = '727-200' ).
    gt_airplanes = value #( base gt_airplanes ( go_airplane ) ).
   " = value #( base ( gt_airplanes ) go_airplane ).
CATCH cx_s4d400_wrong_plane.
    MESSAGE  'planetype does not exist' TYPE 'I'.
