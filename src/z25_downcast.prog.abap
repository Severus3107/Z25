...
CLASS lcl_carrier DEFINITION.
  PUBLIC SECTION.
    ...
    METHODS get_highest_cargo_weight RETURNING VALUE(rv_weight) TYPE i.
  PRIVATE SECTION.
...
CLASS lcl_carrier IMPLEMENTATION.
  ...
  METHOD get_highest_cargo_weight.
    DATA: lo_plane      TYPE REF TO lcl_airplane,
          lo_cargoplane TYPE REF TO lcl_cargo_plane,
          lv_weight     TYPE i,
          lv_maxweight  TYPE i
          .
    lv_maxweight = 0.
    LOOP AT mt_planes INTO lo_plane.
      IF lo_plane IS INSTANCE OF lcl_cargo_plane.
        ...
        lv_weight = lo_cargoplane->get_weight(  ).
        IF lv_weight > lv_maxweight.
          lv_maxweight = lv_weight.
        ENDIF.
      ENDIF.
...
START-OF-SELECTION.
  ...
  gv_highest_weight = go_carrier->get_highest_cargo_weight(  ).
  DATA(gv_output) = | The cargoplane with the highest weight weighs { gv_highest_weight } . |.
  WRITE gv_output.
